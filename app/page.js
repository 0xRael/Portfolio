...
import { Header, Skills, Portfolio, MusicNFT, AnimeRecommender, RedditClone } from "@/components/sections";
...
export default function Home() {
  ...
  const elements = [<Header />, <Skills />, <Portfolio />, <MusicNFT />, <AnimeRecommender />, <RedditClone />];
